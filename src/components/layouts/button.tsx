    ...
    <div>
      {variant === 'primary' && (
        <Link
          href={link}
          onClick={onClick}
          className="custom-transition group relative mt-2 block w-fit cursor-pointer overflow-hidden bg-primary px-4 py-2 font-semibold text-white md:mt-4 lg:mt-6"
        >
